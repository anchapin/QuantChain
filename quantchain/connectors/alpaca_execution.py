...
class AlpacaExecutionConnector(TradingExecutionInterface):
    ...
    def _convert_alpaca_order(self, alpaca_order) -> OrderResult:
        ...
        return OrderResult(
            ...
            side=self.ALPACA_SIDE_MAPPING.get(
                alpaca_order.side, OrderSide.BUY
            ),
    ...
    def get_account(self) -> AccountInfo:
        ...
        try:
            ...
            return AccountInfo(
                ...
                positions=positions,
                margin_available=float(account.daytrading_buying_power) if hasattr(account, 'daytrading_buying_power') else None,
            )
    ...
    def get_market_hours(self, symbol: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "market_type": "crypto" if (symbol and self._is_crypto_symbol(symbol)) else "equity",
            }
    ...
    def close_position(self, symbol: str) -> OrderResult:
        ...
        try:
            ...
            raise ExecutionError(f"Failed to close position for {symbol}: {str(e)}") from e
