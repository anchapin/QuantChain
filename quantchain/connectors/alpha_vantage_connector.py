...
class AlphaVantageDataConnector(DataFeedInterface):
    ...
    def __init__(
        ...
        Args:
            ...
            api_secret: Not used for Alpha Vantage (included for interface
                        compatibility)
            **kwargs: Additional configuration
                - timeout: Request timeout in seconds (default: 30)
                - max_retries: Maximum number of retries (default: 3)
                - cache_ttl: Cache time-to-live for symbol data in seconds
                  (default: 3600)
    ...
    def _convert_timeframe(
        self, timeframe: str, is_forex: bool = False
    ...
    def _refresh_symbol_cache(self) -> None:
        ...
        if (
            ...
            try:
                ...
                self.logger.info(
                    f"Refreshed symbol cache with {len(self._symbol_cache)} symbols"
                )
            except Exception as e:
    ...
    def get_historical_data(
        ...
        if df.empty:
            raise SymbolNotFoundError(
                f"No data found for {symbol} in specified date range"
            )
    ...
    def get_real_time_data(self, symbol: str) -> Dict[str, Any]:
        ...
        if is_forex:
            ...
            result = {
                ...
                "bid": float(
                    quote_data.get("02. price", 0)
                ),  # Alpha Vantage doesn't provide bid/ask
