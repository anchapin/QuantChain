...
def main():
    ...
    low_coverage_modules = [
        (
            "quantchain/core/secret_managers/vault",
            "tests/unit/core/secret_managers/test_vault_basic.py",
        ),
        (
            "quantchain/core/secret_managers/gcp",
            "tests/unit/core/secret_managers/test_gcp_basic.py",
        ),
        (
            "quantchain/core/secret_managers/aws",
            "tests/unit/core/secret_managers/test_aws_basic.py",
        ),
        (
            "quantchain/backtesting/performance_metrics",
            "tests/unit/backtesting/test_performance_metrics_basic.py",
        ),
        (
            "quantchain/backtesting/finrl_adapter",
            "tests/unit/backtesting/test_finrl_adapter_basic.py",
        ),
        (
            "quantchain/backtesting/langgraph_adapter",
            "tests/unit/backtesting/test_langgraph_adapter_basic.py",
        ),
        (
            "quantchain/backtesting/market_friction",
            "tests/unit/backtesting/test_market_friction_basic.py",
        ),
        (
            "quantchain/backtesting/vector_backtester",
            "tests/unit/backtesting/test_vector_backtester_basic.py",
        ),
        (
            "quantchain/tools/web_dashboard",
            "tests/unit/tools/test_web_dashboard_basic.py",
        ),
        (
            "quantchain/tools/model_fine_tuning",
            "tests/unit/tools/test_model_fine_tuning_basic.py",
        ),
    ]
