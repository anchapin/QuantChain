...
class TestCreateSecretManager:
    ...
    def test_create_with_config(self):
        ...
        with patch(
            "quantchain.core.secret_managers.factory.EnvSecretManager"
        ) as mock_class:
    ...
    def test_create_with_kwargs(self):
        ...
        with patch(
            ...
            manager = create_secret_manager(
                backend="env", test_param="test_value", another_param=123
            )
    ...
    def test_create_config_and_kwargs_merge(self):
        ...
        with patch(
            ...
            manager = create_secret_manager(
                backend="env", config=config, param2="new_value2", param3="value3"
            )

            mock_class.assert_called_once_with(
                param1="value1", param2="new_value2", param3="value3"
            )
    ...
    def test_create_backend_runtime_error(self):
        ...
        with patch(
            ...
            assert "Failed to create env secret manager: Connection failed" in str(
                exc_info.value
            )
...
class TestGetDefaultSecretManager:
    ...
    def test_get_default_from_env(self):
        ...
        with patch(
            "quantchain.core.secret_managers.factory.create_secret_manager"
        ) as mock_create:
    ...
    def test_env_backend_warning(self, caplog):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            warning_found = any(
                ...
                and "NOT recommended for production" in record.message
