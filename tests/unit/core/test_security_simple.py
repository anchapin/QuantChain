...
class TestAPISecurityManagerSimple:
    ...
    def test_validate_service_supported(self):
        ...
        manager.set_api_key("alpaca", "ABCDEFGHIJKLMNOPQRST", "wJalrXUtnFEMIK7MDENGbPxRfiCYEXAMPLEKEY123456789")
    ...
    def test_get_service_credentials(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            assert credentials["secret"] == "wJalrXUtnFEMIK7MDENGbPxRfiCYEXAMPLEKEY123456789"
