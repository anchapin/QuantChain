...
try:
    from quantchain.connectors.alpaca_connector import AlpacaConnector, AlpacaDataFeed, AlpacaExecutionInterface
...
@pytest.mark.unit
@pytest.mark.skipif(not ALPACA_CONNECTOR_AVAILABLE, reason="Alpaca connector module not available")
