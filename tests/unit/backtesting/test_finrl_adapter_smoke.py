...
class TestFinRLAdapterSmoke:
    ...
    def test_get_connector_alpaca(self):
        ...
        with patch("quantchain.backtesting.finrl_adapter.AlpacaDataConnector") as mock_alpaca:
            ...
            mock_alpaca.assert_called_once_with(api_key="test_key", api_secret="test_secret")

    def test_get_connector_polygon(self):
        """Test getting Polygon connector."""
        with patch("quantchain.backtesting.finrl_adapter.PolygonDataConnector") as mock_polygon:
            mock_instance = MagicMock()
            ...
            assert connector == mock_instance
            mock_polygon.assert_called_once_with(api_key="test_key", api_secret="test_secret")

    def test_get_connector_ccxt(self):
        """Test getting CCXT connector."""
        with patch("quantchain.backtesting.finrl_adapter.CCXTDataConnector") as mock_ccxt:
            mock_instance = MagicMock()
    ...
    def test_finrl_adapter_init_minimal(self, mock_friction, mock_metrics, mock_get_connector):
    ...
    @patch("quantchain.backtesting.finrl_adapter.PerformanceMetrics")
    @patch("quantchain.backtesting.finrl_adapter.MarketFrictionSimulator")
    def test_finrl_adapter_init_with_balance(self, mock_friction, mock_metrics, mock_get_connector):
    ...
    @patch("quantchain.backtesting.finrl_adapter.PerformanceMetrics")
    @patch("quantchain.backtesting.finrl_adapter.MarketFrictionSimulator")
    def test_finrl_adapter_init_with_features(self, mock_friction, mock_metrics, mock_get_connector):
    ...
    @patch("quantchain.backtesting.finrl_adapter.PerformanceMetrics")
    @patch("quantchain.backtesting.finrl_adapter.MarketFrictionSimulator")
    def test_finrl_adapter_init_with_friction(self, mock_friction, mock_metrics, mock_get_connector):
    ...
    @patch("quantchain.backtesting.finrl_adapter.PerformanceMetrics")
    @patch("quantchain.backtesting.finrl_adapter.MarketFrictionSimulator")
    def test_finrl_adapter_observation_space(self, mock_friction, mock_metrics, mock_get_connector):
    ...
    @patch("quantchain.backtesting.finrl_adapter.PerformanceMetrics")
    @patch("quantchain.backtesting.finrl_adapter.MarketFrictionSimulator")
    def test_finrl_adapter_action_space(self, mock_friction, mock_metrics, mock_get_connector):
    ...
    @patch("quantchain.backtesting.finrl_adapter.PerformanceMetrics")
    @patch("quantchain.backtesting.finrl_adapter.MarketFrictionSimulator")
    def test_finrl_adapter_invalid_action(self, mock_friction, mock_metrics, mock_get_connector):
    ...
    @patch("quantchain.backtesting.finrl_adapter.PerformanceMetrics")
    @patch("quantchain.backtesting.finrl_adapter.MarketFrictionSimulator")
    def test_finrl_adapter_render(self, mock_friction, mock_metrics, mock_get_connector):
    ...
    @patch("quantchain.backtesting.finrl_adapter.PerformanceMetrics")
    @patch("quantchain.backtesting.finrl_adapter.MarketFrictionSimulator")
    def test_finrl_adapter_reward_strategy(self, mock_friction, mock_metrics, mock_get_connector):
