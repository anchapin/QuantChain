"""
Backtesting-specific tests for quantchain/backtesting/market_friction.py.
"""
...
def test_module_structure():
    ...
    try:
        ...
        pytest.skip(f"Cannot import quantchain.backtesting.market_friction")
        ...
        with patch('pandas.DataFrame') as mock_df, \
            ...
            for attr_name in dir(quantchain.backtesting.market_friction):
                if not attr_name.startswith('_'):
                    attr = getattr(quantchain.backtesting.market_friction, attr_name)
...
def test_error_handling():
    ...
    try:
        ...
        for name in dir(quantchain.backtesting.market_friction):
            obj = getattr(quantchain.backtesting.market_friction, name)
