...
class TestPerformanceMetricsComprehensive:
    ...
    def test_calculate_trade_level_metrics_empty_trades(self):
        ...
        trades = pd.DataFrame(columns=['entry_date', 'exit_date', 'entry_price', 'exit_price', 'quantity', 'side'])
    ...
    def test_calculate_performance_metrics_invalid_frequency(self):
        ...
        dates = pd.to_datetime(['2024-01-01', '2024-01-03', '2024-01-05', '2024-01-06'])  # Irregular gaps
    ...
    def test_calculate_performance_metrics_with_transactions(self):
        ...
        metrics = calculator.calculate_performance_metrics(dates, equity, transactions=transactions)
        assert metrics is not None
    ...
    def test_calculate_attribution_analysis(self):
        ...
        attribution = calculator._calculate_attribution_analysis(sector_returns, weights)
    ...
    def test_calculate_scenario_analysis(self):
        ...
        bear_market_equity = 100 * (1 + np.cumsum(np.random.uniform(-0.005, -0.001, 252)))
        
        bull_metrics = calculator.calculate_performance_metrics(dates, bull_market_equity)
        bear_metrics = calculator.calculate_performance_metrics(dates, bear_market_equity)
