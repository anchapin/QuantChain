...
pytestmark = pytest.mark.skipif(
    not LANGGRAPH_ADAPTER_AVAILABLE, 
    reason="LangGraph adapter not available"
)
...
@pytest.mark.skipif(not LANGGRAPH_ADAPTER_AVAILABLE, reason="LangGraph adapter not available")
