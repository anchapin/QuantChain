"""
Backtesting-specific tests for quantchain/backtesting/performance_metrics.py.
"""
...
def test_module_structure():
    ...
    try:
        ...
        pytest.skip(f"Cannot import quantchain.backtesting.performance_metrics")
        ...
        with patch('pandas.DataFrame') as mock_df, \
            ...
            for attr_name in dir(quantchain.backtesting.performance_metrics):
                if not attr_name.startswith('_'):
                    attr = getattr(quantchain.backtesting.performance_metrics, attr_name)
...
def test_error_handling():
    ...
    try:
        ...
        for name in dir(quantchain.backtesting.performance_metrics):
            obj = getattr(quantchain.backtesting.performance_metrics, name)
