...
class TestFinRLAdapterComprehensiveCoverage:
    ...
    def test_market_friction_simulator_initialization(self):
        ...
        config = MarketFrictionConfig(
            ...
            slippage_model=VolumeImpactSlippage(base_rate=0.0001, volume_impact_factor=0.0002),
    ...
    def test_market_friction_simulator_default_initialization(self):
        ...
        config = MarketFrictionConfig(
            ...
            slippage_model=VolumeImpactSlippage(base_rate=0.0001, volume_impact_factor=0.0001),
            latency_model=FixedLatency(latency_ms=50)
        )
    ...
    def test_performance_metrics_calculate_max_drawdown(self):
        ...
        equity_curve = pd.Series([100000, 110000, 95000, 120000, 90000, 95000], index=dates)
    ...
    def test_ccxt_connector_initialization(self):
        ...
        with patch("quantchain.connectors.ccxt_connector.ccxt", mock_ccxt), \
             patch("quantchain.connectors.ccxt_connector.CCXT_AVAILABLE", True):
