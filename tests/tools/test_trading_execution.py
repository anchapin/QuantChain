...
class TestOrderRequest:
    ...
    def test_stop_limit_order_missing_prices(self):
        ...
        with pytest.raises(ValidationError, match="Stop limit orders require both price and stop_price"):
            OrderRequest(
                symbol="AAPL",
                side=OrderSide.BUY,
                order_type=OrderType.STOP_LIMIT,
...
class TestOrderResult:
    ...
    def test_partially_filled_order_properties(self):
    ...
    def test_pending_order_properties(self):
