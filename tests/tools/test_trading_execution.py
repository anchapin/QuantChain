...
class TestOrderRequest:
    ...
    def test_valid_market_order(self) -> None: """Test creation of a valid market order."""
        order = OrderRequest(
    ...
    def test_valid_limit_order(self) -> None: """Test creation of a valid limit order."""
        order = OrderRequest(
            symbol="MSFT",
            side=OrderSide.SELL,
    ...
    def test_valid_stop_order(self) -> None: """Test creation of a valid stop order."""
        order = OrderRequest(
            symbol="TSLA",
            side=OrderSide.BUY,
    ...
    def test_valid_stop_limit_order(self) -> None: """Test creation of a valid stop limit order."""
        order = OrderRequest(
            symbol="NVDA",
            side=OrderSide.SELL,
    ...
    def test_invalid_quantity(self) -> None: """Test that orders with invalid quantity raise ValidationError."""
    ...
    def test_limit_order_without_price(self) -> None: """Test that limit orders without price raise ValidationError."""
    ...
    def test_stop_order_without_stop_price(self) -> None: """Test that stop orders without stop price raise ValidationError."""
    ...
    def test_stop_limit_order_missing_prices(self) -> None: """Test that stop limit orders without required prices raise ValidationError."""
        with pytest.raises(
...
class TestOrderResult:
    ...
    def test_filled_order_properties(self) -> None: """Test properties of a filled order."""
        timestamp = datetime.now()
        order = OrderResult(
            order_id="test-order",
    ...
    def test_partially_filled_order_properties(self) -> None: """Test properties of a partially filled order."""
        timestamp = datetime.now()
        order = OrderResult(
            order_id="test-order",
            client_order_id="client-123",
    ...
    def test_pending_order_properties(self) -> None: """Test properties of a pending order."""
        timestamp = datetime.now()
        order = OrderResult(
            order_id="test-order",
            client_order_id="client-123",
...
class TestPosition:
    ...
    def test_long_position(self) -> None: """Test properties of a long position."""
        position = Position(
            symbol="AAPL",
            quantity=100,
    ...
    def test_short_position(self) -> None: """Test properties of a short position."""
        position = Position(
            symbol="AAPL",
            quantity=-50,
            avg_entry_price=150.0,
    ...
    def test_flat_position(self) -> None: """Test properties of a flat position."""
        position = Position(
            symbol="AAPL",
            quantity=0,
            avg_entry_price=0.0,
...
class TestAccountInfo:
    ...
    def test_account_properties(self) -> None: """Test account info properties."""
        positions = [
...
class TestTradingExecutionInterface:
    ...
    def test_interface_methods_exist(self) -> None: """Test that all required abstract methods are defined."""
    ...
    def test_mock_implementation(self) -> None: """Test that mock implementation works correctly."""
    ...
    def test_order_not_found_error(self) -> None: """Test OrderNotFoundError is raised for missing orders."""
        executor = MockTradingExecutor()
    ...
    def test_order_history_filtering(self) -> None: """Test order history filtering functionality."""
        executor = MockTradingExecutor()
