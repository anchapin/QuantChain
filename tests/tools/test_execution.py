...
from quantchain.tools.trading_execution import OrderRequest, OrderSide, OrderType, OrderResult
...
class TestAlpacaExecutionToolIntegration:
    ...
    def test_error_propagation(self) -> None:
        ...
        with patch('quantchain.tools.execution.AlpacaExecutionConnector') as mock_connector_class:
            mock_connector = MagicMock()
            mock_connector.submit_market_order.side_effect = ExecutionError("Network error")
            mock_connector_class.return_value = mock_connector
