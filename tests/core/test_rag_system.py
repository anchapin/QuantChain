...
class TestChromaVectorStore:
    ...
    def test_chroma_store_init_success(self, mock_chromadb):
    ...
    def test_chroma_store_init_import_error(self):
    ...
    @patch("quantchain.core.rag_system.chromadb")
    def test_chroma_store_store(self, mock_chromadb):
    ...
    @patch("quantchain.core.rag_system.chromadb")
    def test_chroma_store_search(self, mock_chromadb):
    ...
    @patch("quantchain.core.rag_system.chromadb")
    def test_chroma_store_delete(self, mock_chromadb):
...
class TestSentenceTransformerProvider:
    ...
    def test_sentence_transformer_init_success(self, mock_transformer):
    ...
    def test_sentence_transformer_init_import_error(self):
    ...
    @patch("quantchain.core.rag_system.SentenceTransformer")
    def test_sentence_transformer_encode(self, mock_transformer):
...
class TestMarketDataRAG:
    ...
    def test_rag_init(self, mock_vector_store, mock_embedding_provider):
    ...
    def test_store_market_data(self, mock_vector_store, mock_embedding_provider):
    ...
    def test_retrieve_relevant_data(self, mock_vector_store, mock_embedding_provider):
    ...
    def test_market_data_to_text(self, mock_vector_store, mock_embedding_provider):
