...
def test_data_feed_interface_is_abstract() -> None:
    """Test that DataFeedInterface cannot be instantiated directly."""
    with pytest.raises(TypeError):
        DataFeedInterface("key", "secret")


def test_data_feed_interface_abstract_methods() -> None:
...
def test_data_feed_interface_init_signature() -> None:
...
def test_data_feed_interface_method_signatures() -> None:
