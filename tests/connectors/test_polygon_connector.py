...
class TestPolygonDataConnector:
    ...
    def test_is_forex_symbol(self, connector: PolygonDataConnector) -> None:
        ...
        assert connector._is_forex_symbol("EUR/USD") is False  # EUR/USD is not a Polygon forex format
    ...
    def test_get_real_time_data_equity(
        ...
        with patch.object(connector.client, "get_last_trade") as mock_trade, \
             patch.object(connector.client, "get_last_quote") as mock_quote:
    ...
    def test_get_real_time_data_forex(
        ...
        with patch.object(connector.client, "get_real_time_currency_conversion") as mock_fx:
    ...
    def test_get_symbol_info_forex(
        self, connector: PolygonDataConnector
    ) -> None:
    ...
    def test_refresh_symbol_cache(self, connector: PolygonDataConnector, sample_ticker) -> None:
    ...
    def test_cache_expiration(self, connector: PolygonDataConnector, sample_ticker) -> None:
