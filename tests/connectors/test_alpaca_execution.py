...
class TestAlpacaExecutionConnector:
    ...
    def mock_client(self):
        ...
        with patch('quantchain.connectors.alpaca_execution.TradingClient') as mock_trading_client:
    ...
    def test_initialization(self):
        ...
        with patch('quantchain.connectors.alpaca_execution.TradingClient') as mock_client_class:
            mock_client = Mock()
    ...
    def test_convert_order_status(self, connector):
        ...
        assert connector._convert_order_status("partially_filled") == OrderStatus.PARTIALLY_FILLED
