...
class TestAlpacaDataConnector:
    ...
    def test_authentication_error(self) -> None:
        ...
        with patch('quantchain.connectors.alpaca_connector.StockHistoricalDataClient') as mock_client:
    ...
    def test_refresh_symbol_cache(self) -> None:
        ...
        with patch('quantchain.connectors.alpaca_connector.StockHistoricalDataClient'):
            with patch('quantchain.connectors.alpaca_connector.TradingClient') as mock_trading:
                # Mock assets
    ...
    def test_get_historical_data_crypto(self) -> None:
        ...
        with patch('quantchain.connectors.alpaca_connector.pd.DataFrame') as mock_df:
            with patch('quantchain.connectors.alpaca_connector.CryptoHistoricalDataClient'):
                ...
                connector.crypto_client.get_crypto_bars.return_value = {"BTC/USD": mock_bars}

                result = connector.get_historical_data("BTC-USD", "1D")  # Test normalization
    ...
    def test_get_historical_data_retry_exhausted(self) -> None:
        ...
        connector.stock_client = MagicMock()
        connector.stock_client.get_stock_bars.side_effect = Exception("Persistent failure")
    ...
    def test_get_real_time_data_stock(self) -> None:
        ...
        connector.stock_client = MagicMock()
        connector.stock_client.get_stock_latest_quote.return_value = {"AAPL": mock_quote}
    ...
    def test_get_real_time_data_crypto(self) -> None:
        ...
        mock_quote.timestamp = datetime.now()
        connector.crypto_client = MagicMock()
        connector.crypto_client.get_crypto_latest_quote.return_value = {"BTC/USD": mock_quote}

        result = connector.get_real_time_data("BTC-USD")  # Test normalization

        # Check that client was called with normalized symbol
        connector.crypto_client.get_crypto_latest_quote.assert_called_once_with("BTC/USD")
